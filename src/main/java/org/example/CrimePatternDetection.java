...
public class CrimePatternDetection {
        ...
        Pattern<Tuple5<String, String, String, Double, Double>, ?> crimePattern = Pattern
                ...
                .where(new IterativeCondition<Tuple5<String, String, String, Double, Double>>() {
                    ...
                    public boolean filter(Tuple5<String, String, String, Double, Double> event, Context<Tuple5<String, String, String, Double, Double>> ctx) throws Exception {
                        // 获取之前匹配的 R 或 Z1 事件
                        Tuple5<String, String, String, Double, Double> previousEvent = null;
                        for (Tuple5<String, String, String, Double, Double> e : ctx.getEventsForPattern("Z1")) {
                        ...
                        // 判断速度
                        double speed = SpeedCalculator.calculateSpeed(
                                previousEvent.f1, event.f1,
                                previousEvent.f3, previousEvent.f4,
                                event.f3, event.f4);

                        return speed <= MAX_HUMAN_SPEED_KMPH;
                    }
                })
                .followedByAny("B")
                .where(new IterativeCondition<Tuple5<String, String, String, Double, Double>>() {
                ...
                .where(new IterativeCondition<Tuple5<String, String, String, Double, Double>>() {
                    ...
                    public boolean filter(Tuple5<String, String, String, Double, Double> event, Context<Tuple5<String, String, String, Double, Double>> ctx) throws Exception {
                        // 获取之前匹配的 B 或 Z2 事件
                        Tuple5<String, String, String, Double, Double> previousEvent = null;
                        for (Tuple5<String, String, String, Double, Double> e : ctx.getEventsForPattern("Z2")) {
                            previousEvent = e; // 获取最后一个 Z2
                        }
                        if (previousEvent == null) {
                            // 如果没有 Z2，则获取 B
                            for (Tuple5<String, String, String, Double, Double> e : ctx.getEventsForPattern("B")) {
                                previousEvent = e;
                            }
                        }
                ...
                .within(Time.minutes(60)); // 整个模式必须在 30 分钟内发生
